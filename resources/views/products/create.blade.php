            ...
            <div class="row">
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modalLabel">How to crop image before upload image in laravel 9 -
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <img id="image" class="image"
                                                src="https://avatars0.githubusercontent.com/u/" alt="image not found">
                                        </div>
                                        <div class="col-md-4">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="number" name="discount" class="form-control" id="discount_price"
